...
// Начало урока (part) живёт столько же, сколько исходник: пока запись в буфере,
// пост в канале можно поправить, приложив кусок заново.
const TTL_SHARE = { source: 1, audio: 0.5, clip: 1, part: 1, subtitles: 10 };
