    ...
    drawingReady
      ? `<label class="field">Запрос для рисования — по-английски
         ...
         <p class="hint">
           ${
             lesson.coverPrompt
               ? 'Последняя обложка нарисована по этому запросу. Поправьте его и нажмите «Нарисовать обложку» — портал нарисует ровно по нему. Очистите поле — запрос заново составит Gemini. Пишите, что должно быть на картинке: «no …» модель читает как «нарисуй …».'
               : 'Поле можно оставить пустым: запрос составит Gemini. Свой запрос пишите по-английски — модель рисования русский понимает плохо. Пишите, что должно быть на картинке: «no …» модель читает как «нарисуй …».'
           }
         </p>`
      : `<p class="hint">
