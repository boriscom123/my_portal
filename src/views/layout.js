...
<!-- Летающий знак. Отдельный слой поверх страницы, а не тот же узел, что в
     шапке: ракета в шапке — это стоянка, и вырывать её из разметки ради полёта
     значит ломать вёрстку шапки на время движения.
     Слой не ловит нажатия: иначе пролетающая ракета перехватывала бы их у
