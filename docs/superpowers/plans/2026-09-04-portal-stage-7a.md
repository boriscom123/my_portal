...
> **ОТЛОЖЕН 9 сентября 2026.** Этот план описывает основание сразу для восьми
> площадок: реестр адаптеров, страницу настроек, общий шаг конвейера. Заказчик
> выбрал другой порядок — «у каждой площадки свой обработчик и свой запуск,
> объединим потом», — и по нему сделаны YouTube, канал Telegram и канал MAX
> (см. `2026-09-08-youtube-publishing.md` и код в `src/services/platforms/`).
>
> Из этого плана взято одно решение — публикация привязана к файлу, а не к
> уроку (задача 1). Остальное вернётся, когда площадок станет достаточно, чтобы
> стало видно, что у них правда общего. Пока он лежит здесь как замысел, а не
